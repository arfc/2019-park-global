...
fig, ax = plt.subplots()
ax.plot(t[1:], heat[1:] / max(heat) * 100, label=r'Start-up')
ax.plot(tl[1:], heatl[1:] / max(heatl) * 100, label=r'Early-life')
ax.plot(tq[1:], heatq[1:] / max(heatq) * 100, label=r'Equilibrium')
