...
In line with the purpose of the \gls{MSFR} as a thorium breeder, its chosen 
        ...
        These distributions will give insight into MSFR behavior during
        transients, and identify potential risks that may warrant further
        study and changes to the fuel composition or the online fuel
        reprocessing scheme.
\end{abstract}
