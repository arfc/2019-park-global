...
In line with the purpose of the \gls{MSFR} as a thorium breeder, its chosen 
        ...
        continuous-energy Monte Carlo code used in numerous reactor physics 
        applications. For verification, group constants and reactivity 
        coefficients will be compared with existing data 
